...
var dom = {};
dom.ButtonSound = function() {
	haxor.core.Application.call(this);
};
$hxClasses["dom.ButtonSound"] = dom.ButtonSound;
dom.ButtonSound.__name__ = ["dom","ButtonSound"];
dom.ButtonSound.__interfaces__ = [haxor.core.IUpdateable];
dom.ButtonSound.__super__ = haxor.core.Application;
dom.ButtonSound.prototype = $extend(haxor.core.Application.prototype,{
	Load: function() {
		haxor.core.Asset.LoadSound("hit","http://haxor.thelaborat.org/resources/sound/hit_sword_00.ogg");
	}
	,Build: function() {
		console.log("ButtonSound> Build");
		this.clicks = 0;
		this.timer = 0.0;
		...
		this.progress = window.document.getElementById("progress");
		haxor.media.Sound.set_main(0.5);
		this.button.onclick = function(ev) {
			var snd = haxor.core.Asset.Get("hit");
			snd.set_volume(0.5);
			snd.Play();
		};
	...
	,Initialize: function() {
		console.log("ButtonSound> Initialize");
		this.get_stage().set_visible(false);
		haxor.core.Engine.Add(this);
	}
	,OnUpdate: function() {
	}
	,__class__: dom.ButtonSound
});
dom.ButtonTimer = function() {
	haxor.core.Application.call(this);
};
$hxClasses["dom.ButtonTimer"] = dom.ButtonTimer;
dom.ButtonTimer.__name__ = ["dom","ButtonTimer"];
dom.ButtonTimer.__interfaces__ = [haxor.core.IUpdateable];
dom.ButtonTimer.__super__ = haxor.core.Application;
dom.ButtonTimer.prototype = $extend(haxor.core.Application.prototype,{
	Build: function() {
		var _g = this;
		console.log("ButtonTimer> Build");
		this.clicks = 0;
		this.timer = 0.0;
		this.button = window.document.getElementById("button");
		this.field = window.document.getElementById("field");
		...
		this.progress = window.document.getElementById("progress");
		this.button.onclick = function(ev) {
			_g.clicks = (_g.clicks + 1) % 4;
		};
		this.logo.style.display = "none";
		this.progress.style.display = "none";
	}
	,Initialize: function() {
		console.log("ButtonTimer> Initialize");
		this.get_stage().set_visible(false);
		haxor.core.Engine.Add(this);
	}
	,OnUpdate: function() {
		...
		case 0:
			this.timer = 0.0;
			this.field.innerText = "Haxor Hello World";
			break;
		case 1:
			this.timer += haxor.core.Time.get_deltaTime();
			this.field.innerText = "Clock: " + haxor.math.Mathf.RoundPlaces(this.timer,1);
			break;
		case 2:
			this.timer += haxor.core.Time.get_deltaTime() * 3.0;
			this.field.innerText = "Clock: " + haxor.math.Mathf.RoundPlaces(this.timer,1);
			break;
		case 3:
			break;
	...
	,__class__: dom.ButtonTimer
});
dom.ButtonTween = function() {
	haxor.core.Application.call(this);
};
$hxClasses["dom.ButtonTween"] = dom.ButtonTween;
dom.ButtonTween.__name__ = ["dom","ButtonTween"];
dom.ButtonTween.__interfaces__ = [haxor.core.IUpdateable];
dom.ButtonTween.__super__ = haxor.core.Application;
dom.ButtonTween.prototype = $extend(haxor.core.Application.prototype,{
	Build: function() {
		console.log("ButtonTween> Build");
		this.clicks = 0;
		this.timer = 0.0;
		this.button = window.document.getElementById("button");
		this.field = window.document.getElementById("field");
	...
	,Initialize: function() {
		var _g = this;
		console.log("ButtonTween> Initialize");
		this.get_stage().get_element().appendChild(this.button.parentElement);
		this.get_stage().set_overflow("hidden");
		this.sprite = new haxor.ui.Sprite(null,"./assets/img/logo.png");
		this.get_stage().AddChild(this.sprite);
		this.sprite.set_width(this.sprite.set_height(256));
		this.sprite.set_y(50);
		this.sprite.set_alpha(0.0);
		haxor.core.Tween.Add(this.sprite,"alpha",1.0,2.0,3.0,haxor.math.Cubic.Out);
		this.button.onclick = function(ev) {
			var px = haxor.math.Mathf.Lerp(0.0,_g.get_stage().get_width() - _g.sprite.get_width(),Math.random());
			haxor.core.Tween.Add(_g.sprite,"x",px,0.8,0.0,haxor.math.Elastic.OutBig);
		};
		haxor.core.Engine.Add(this);
	}
	,OnUpdate: function() {
	}
	,__class__: dom.ButtonTween
});
dom.InputTest = function() {
	haxor.core.Application.call(this);
};
$hxClasses["dom.InputTest"] = dom.InputTest;
dom.InputTest.__name__ = ["dom","InputTest"];
dom.InputTest.__interfaces__ = [haxor.core.IUpdateable];
dom.InputTest.__super__ = haxor.core.Application;
dom.InputTest.prototype = $extend(haxor.core.Application.prototype,{
	Build: function() {
		console.log("InputTest> Build");
		this.button = window.document.getElementById("button");
		this.field = window.document.getElementById("field");
		this.logo = window.document.getElementById("logo");
		this.progress = window.document.getElementById("progress");
	...
	,Initialize: function() {
		console.log("InputTest> Initialize");
		haxor.core.Engine.Add(this);
	}
	,OnUpdate: function() {
		this.field.innerText = "Mouse\nx[" + haxor.input.Input.mouse.x + "] y[" + haxor.input.Input.mouse.y + "]\nrx[" + haxor.math.Mathf.RoundPlaces(haxor.input.Input.relativeMouse.x,2) + "] ry[" + haxor.math.Mathf.RoundPlaces(haxor.input.Input.relativeMouse.y,2) + "]\nstate[" + Std.string(haxor.input.Input.GetInputState(haxor.input.KeyCode.Mouse0)) + "]\nhold[" + haxor.math.Mathf.Floor(haxor.input.Input.GetHoldTime(haxor.input.KeyCode.Mouse0)) + "]";
	}
	,__class__: dom.InputTest
});
dom.Main = function() { };
$hxClasses["dom.Main"] = dom.Main;
dom.Main.__name__ = ["dom","Main"];
dom.Main.main = function() {
	console.log("Main> Starting DOM Examples");
};
dom.TouchTest = function() {
	haxor.core.Application.call(this);
};
$hxClasses["dom.TouchTest"] = dom.TouchTest;
dom.TouchTest.__name__ = ["dom","TouchTest"];
dom.TouchTest.__interfaces__ = [haxor.core.IUpdateable];
dom.TouchTest.__super__ = haxor.core.Application;
dom.TouchTest.prototype = $extend(haxor.core.Application.prototype,{
	Build: function() {
		console.log("TouchTest> Build");
		this.button = window.document.getElementById("button");
		this.field = window.document.getElementById("field");
		this.logo = window.document.getElementById("logo");
		this.progress = window.document.getElementById("progress");
	...
	,Initialize: function() {
		console.log("TouchTest> Initialize");
		haxor.core.Engine.Add(this);
	}
	,OnUpdate: function() {
		var tl = haxor.input.Input.get_touch();
		if(tl.length <= 0) this.field.innerText = "No Touches!"; else {
			...
			while(_g1 < _g) {
				var i = _g1++;
				var t = tl[i];
				this.field.innerText += "Touch[" + t.id + "]\nx[" + t.position.x + "] y[" + t.position.y + "]\ndx[" + t.delta.x + "] dy[" + t.delta.y + "]\nstate[" + Std.string(t.state) + "]\nhold[" + (t.hold | 0) + "]\n";
			}
		}
	}
	,__class__: dom.TouchTest
});
dom.WebTest = function() {
	haxor.core.Application.call(this);
};
$hxClasses["dom.WebTest"] = dom.WebTest;
dom.WebTest.__name__ = ["dom","WebTest"];
dom.WebTest.__interfaces__ = [haxor.core.IUpdateable];
dom.WebTest.__super__ = haxor.core.Application;
dom.WebTest.prototype = $extend(haxor.core.Application.prototype,{
	Build: function() {
		var _g1 = this;
		console.log("WebTest> Build");
		this.button = window.document.getElementById("button");
		this.field = window.document.getElementById("field");
		this.logo = window.document.getElementById("logo");
		this.progress = window.document.getElementById("progress");
	...
	,Initialize: function() {
		console.log("WebTest> Initialize");
		this.get_stage().set_visible(false);
		haxor.core.Engine.Add(this);
	}
	,ProcessLoad: function() {
		...
		this.progress.value = 1.0 - this.queue.length / this.queue_length;
		var url = this.queue[0];
		haxor.net.Web.LoadImage(url,function(img,p) {
			if(p >= 1.0) {
				if(img != null) {
					var e = img;
					e.style.position = "absolute";
					e.style.left = haxor.math.Mathf.Lerp(-20,-50,Math.random()) + "px";
					e.style.top = haxor.math.Mathf.Lerp(0,800,Math.random()) + "px";
					e.style.transition = "left 0.5s, top 0.5s";
					haxe.Timer.delay(function() {
						e.style.left = haxor.math.Mathf.Lerp(0,1000,Math.random()) + "px";
						e.style.top = haxor.math.Mathf.Lerp(0,800,Math.random()) + "px";
					},500);
	...
	,LoadImage: function() {
		haxor.net.Web.root = "http://haxor.thelaborat.org/resources/";
		var rnd = Math.random();
		var links = ["./texture/misc/compatible_ie.gif?" + rnd,"./texture/misc/compatible_firefox.gif?" + rnd,"./texture/misc/compatible_chrome.gif?" + rnd];
		links.sort(function(a,b) {
			if(Math.random() < 0.5) return -1; else return 1;
		});
		this.queue.push(links[0]);
		this.queue_length = haxor.math.Mathf.Max([this.queue.length,this.queue_length]);
		if(this.queue.length <= 1) this.ProcessLoad();
	}
	,OnUpdate: function() {
	}
	,__class__: dom.WebTest
});
var haxe = {};
