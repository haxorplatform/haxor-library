...
haxor.core.Application.__properties__ = {get_protocol:"get_protocol"}
...
haxor.core.Application.prototype = $extend(haxor.core.Entity.prototype,{
	...
	,LoadStandardLib: function() {
		...
		haxor.core.Asset.LoadCollada("haxor/primitive/cube","./asset/collada/cube.DAE");
		haxor.core.Asset.LoadCollada("haxor/primitive/sphere","./asset/collada/sphere.DAE");
		haxor.core.Asset.LoadCollada("haxor/primitive/teapot","./asset/collada/teapot.DAE");
		haxor.core.Asset.LoadCollada("haxor/primitive/torus","./asset/collada/torus.DAE");
		haxor.core.Asset.LoadTextureHTML("haxor/texture/logo","./texture/logo.png");
		...
		haxor.core.Asset.LoadTextureHTML("haxor/texture/particle","./texture/particle.png");
...
haxor.Main.prototype = $extend(haxor.core.Application.prototype,{
	...
	,Initialize: function() {
		...
		var orbit_input = camera_orbit.AddComponent(haxor.component.CameraOrbitMouseInput);
...
haxor.api.TextureAPI.WriteTexture = function(p_flag,p_texture) {
	...
	if(p_flag == 3553) haxor.api.TextureAPI.c.pixelStorei(37440,0);
	if(is_element) {
		if(p_flag == 3553) haxor.api.TextureAPI.c.pixelStorei(37440,1);
...
haxor.component.CameraOrbitMouseInput = function(p_entity) {
...
$hxClasses["haxor.component.CameraOrbitMouseInput"] = haxor.component.CameraOrbitMouseInput;
haxor.component.CameraOrbitMouseInput.__name__ = ["haxor","component","CameraOrbitMouseInput"];
haxor.component.CameraOrbitMouseInput.__interfaces__ = [haxor.core.IUpdateable];
haxor.component.CameraOrbitMouseInput.__super__ = haxor.component.Behaviour;
haxor.component.CameraOrbitMouseInput.prototype = $extend(haxor.component.Behaviour.prototype,{
	OnStart: function() {
		this.m_orbit = this.GetComponent(haxor.component.CameraOrbit);
	}
	,OnUpdate: function() {
		var dx = haxor.input.Input.deltaMouse.x;
		var dy = haxor.input.Input.deltaMouse.y;
		if(this.rotate) {
			if(haxor.input.Input.GetInputState(haxor.input.KeyCode.Mouse0) == haxor.input.InputState.Hold) {
	...
	,__class__: haxor.component.CameraOrbitMouseInput
});
...
haxor.core.Engine.Run = function() {
	...
	haxor.core.Application.TraverseDOM(function(n) {
		if(js.Boot.__instanceof(n,HTMLScriptElement)) {
			var e = n;
		...
		if(p >= 1) {
			if(haxor.core.Engine.get_application().get_loader() != null) {
				if(haxor.core.Engine.get_application().get_loader().m_complete) {
					if(haxor.core.Engine.get_application().get_loader().get_parent() != null) return;
...
haxor.graphics.Graphics.Initialize = function(p_canvas) {
	var success = true;
	var mode;
	if(p_canvas.getAttribute("mode") == null) mode = "3d"; else mode = p_canvas.getAttribute("mode").toLowerCase();
	var attrib3 = { };
...
haxor.graphics.Screen.SetFullscreen = function(p_element,p_flag,p_keyboard) {
	...
	} else if(d.cancelFullScreen) d.cancelFullScreen(); else if(d.mozCancelFullScreen) d.mozCancelFullScreen(); else if(d.webkitCancelFullScreen) d.webkitCancelFullScreen();
};
...
haxor.input.Input.OnTouch = function(p_event) {
	...
	if(haxor.input.Input.m_hasActiveTouches) p_event.preventDefault();
};
...
haxor.math.AABB2.prototype = {
	get_clone: function() {
		return new haxor.math.AABB2(this.get_x(),this.get_y(),this.get_width(),this.get_height());
	}
	,get_min: function() {
...
haxor.math.AABB3.prototype = {
	get_clone: function() {
		return new haxor.math.AABB3(this.get_x(),this.get_y(),this.get_z(),this.get_width(),this.get_height(),this.get_depth());
	}
	,get_min: function() {
...
haxor.math.Matrix4.LookAt = function(p_from,p_at,p_up) {
	...
	m.Set(vx.x,vx.y,vx.z,-haxor.math.Vector3.Dot(vx,p_from),vy.x,vy.y,vy.z,-haxor.math.Vector3.Dot(vy,p_from),vz.x,vz.y,vz.z,-haxor.math.Vector3.Dot(vz,p_from),0,0,0,1);
	return m;
};
...
haxor.texture.RenderTexture = function(p_width,p_height,p_format,p_store_depth) {
	...
	this.m_format = p_format;
	if(p_store_depth) this.m_depth = new haxor.texture.Texture2D(this.m_width,this.m_height,haxor.texture.TextureFormat.Depth);
	haxor.api.TextureAPI.Create(this);
};
...
haxor.ui.UIEntity.prototype = $extend(haxor.core.Resource.prototype,{
	...
	,get_stage: function() {
		return this.get_application().get_stage();
	}
	...
	,UpdateMaterial: function() {
		...
		e.style.opacity = "" + (this.m_globalAlpha * 0.99 * 100 | 0) / 100;
		if(this.m_globalVisible) e.style.display = "inline"; else e.style.display = "none";
	}
	,UpdateRect: function() {
		var e = this.m_element;
		var m = this.get_layout().get_margin();
	...
	,UpdateTransform: function() {
		...
		var m = this.get_layout().get_margin();
		this.get_layout().Update();
		e.style.left = Std["int"](this.m_x - this.m_px + m.get_xMin()) + "px";
		e.style.top = Std["int"](this.m_y - this.m_py + m.get_yMin()) + "px";
	}
	,OnRepaint: function() {
	}
...
haxor.ui.Container.prototype = $extend(haxor.ui.UIEntity.prototype,{
	...
	,AddChildAt: function(p_child,p_index) {
		...
		this.m_children.splice(pos,0,p_child);
...
haxor.ui.HaxorCanvas = function(p_element,p_alpha,p_antialias,p_depth,p_stencil,p_premultiplied_alpha,p_preserve_buffer) {
	...
	if(p_element == null) {
		...
		if(this.get_stage() != null) this.get_stage().AddChildAt(this,0);
	}
};
...
haxor.ui.HaxorLoader = function() {
	...
	this.m_fill.set_image(this.get_stage().get_document().getElementById("hxp_fill"));
...
haxor.ui.Sprite.prototype = $extend(haxor.ui.Container.prototype,{
	...
	,set_image: function(v) {
		if(this.m_buffer == null) {
			if(this.m_image != null) this.m_element.removeChild(this.m_image);
		}
		if(this.m_image == null) {
			if(v != null) {
				this.set_width(v.naturalWidth);
				this.set_height(v.naturalHeight);
			}
		}
		this.m_image = v;
		if(this.m_buffer == null) {
	...
	,OnRepaint: function() {
		...
		if(this.m_buffer != null) {
			...
			if(this.m_pattern) this.m_image.style.display = "none"; else this.m_image.style.display = "inline";
...
haxor.ui.Stage = function() {
	...
	this.m_mouseX = 0;
	this.m_mouseY = 0;
	this.get_body().appendChild(this.m_element);
...
haxor.ui.Stage.prototype = $extend(haxor.ui.Container.prototype,{
	...
	,get_width: function() {
		this.get_body().style.overflow = "hidden";
		var v = this.get_window().innerWidth;
		this.get_body().style.overflow = "";
		return v;
	}
	,set_height: function(v) {
		return v;
	...
	,__properties__: $extend(haxor.ui.Container.prototype.__properties__,{get_window:"get_window",get_document:"get_document",get_body:"get_body"})
});
...
haxor.ui.TextField = function(p_tag) {
	...
	this.m_element.style.whiteSpace = "normal";
	this.m_field.style.width = "100%";
...
haxor.ui.TextField.prototype = $extend(haxor.ui.UIEntity.prototype,{
	...
	,set_text: function(v) {
		this.m_text = v;
		var f = this.m_field;
		if(js.Boot.__instanceof(f,HTMLInputElement)) f.value = v; else f.innerHTML = v;
		this.UpdateRect();
		return v;
	}
	,get_color: function() {
	...
	,get_textWidth: function() {
		var need_append = this.m_element.parentElement == null;
		if(need_append) window.document.body.appendChild(this.m_element);
		var tw = 0;
		if(!this.get_wordwrap()) tw = this.m_field.clientWidth; else tw = this.m_field.clientWidth;
		if(need_append) window.document.body.removeChild(this.m_element);
		return tw;
	}
	...
	,get_lineHeight: function() {
		...
		th = this.m_field.clientHeight;
		if(js.Boot.__instanceof(f,HTMLInputElement)) f.value = t; else f.innerHTML = t;
		if(need_append) window.document.body.removeChild(this.m_element);
		return th;
	}
...
var iid = setInterval(function(){ clearInterval(iid); haxor.core.Engine.Run();  },500);
var q = window.jQuery;
js.JQuery = q;
...
haxor.component.Camera.cp = haxor.math.Vector4.get_zero();
haxor.component.Camera.pp = haxor.math.Vector4.get_zero();
...
haxor.core.Engine.VERSION_BUILD = 0;
...
haxor.thread.ParticleKernel.DATA_SIZE = 256;
