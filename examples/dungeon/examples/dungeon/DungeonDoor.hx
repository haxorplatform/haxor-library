...
class DungeonDoor extends Behaviour
{
	...
	override public function OnStart():Void 
	{
		...
		transform.Traverse(function(it : Transform):Bool
		{
	...
	public function Open():Void
	{
		...
		Tween.Add(m_left, "rotation", Quaternion.FromAxisAngle(Vector3.up,  80), 1.5, 0.0, Cubic.OutBack);
		Tween.Add(m_right, "rotation", Quaternion.FromAxisAngle(Vector3.up, -80), 1.5, 0.0, Cubic.OutBack);
	...
	public function Close():Void
	{
		...
		Tween.Add(m_left, "rotation", Quaternion.FromAxisAngle(Vector3.up,  0), 1.5, 0.0, Cubic.Out);
		Tween.Add(m_right, "rotation", Quaternion.FromAxisAngle(Vector3.up, 0), 1.5, 0.0, Cubic.Out);
